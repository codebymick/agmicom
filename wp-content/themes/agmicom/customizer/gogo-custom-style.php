...
//gogo_theme_clr CSS
		...
		}.portfolio-wrapper .button:active, .portfolio-wrapper .button:focus, .portfolio-wrapper .button:hover, .portfolio-wrapper .button:visited,.gogo-menu li.on-section a span{
			color:{$gogo_theme_clr};
		}";
...
function gogo_typewriter_letterspacing_responsive( $value, $dimension = 'desktop' ){
   ...
   $custom_css .= '.thunk-typed-box .type-demo{
   gogo_typewriter_letterspacing: ' . $v3 . 'px;
   }';
   $custom_css = gogo_add_media_query($dimension, $custom_css);
   return $custom_css;
}
$gogo_style.= gogo_responsive_slider_funct('gogo_typewriter_size','gogo_typewriter_fontsize_responsive');
$gogo_style.= gogo_responsive_slider_funct('gogo_typewriter_size','gogo_typewriter_lineheight_responsive');
